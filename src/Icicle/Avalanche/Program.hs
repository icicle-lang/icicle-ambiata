...
data Statement n p
 ...
 | Foreach (Name n) (Exp n p) (Exp n p)   (Statement n p)

 -- | Execute a block.
 -- This is silly, but for now it can be generated by
 -- forwarding some lets.
 | Block                        [Statement n p]
 ...
 transformX names exps stmt
  = case stmt of
     ...
     Foreach n from to ss
      -> Foreach <$> names n <*> exps from <*> exps to <*> go ss
     Block ss
      -> Block <$> gos ss
