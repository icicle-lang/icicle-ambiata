...
seaOfZebraDriver :: [InputId] -> [Cluster a] -> Either SeaError Doc
...
--   ...
-- }
seaOfDefRead :: [(Int, Cluster a)] -> Doc
...
-- }
--
seaOfDefReadProgram :: Cluster a -> Doc
