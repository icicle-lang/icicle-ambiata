...
seaOfWriteFleetOutput :: PsvOutputConfig -> PsvOutputWhiteList -> [Cluster a] -> Either SeaError Doc
...
seaOfGetOutputSchema :: PsvOutputConfig -> [Cluster a] -> Either SeaError Doc
...
seaOfWriteProgramOutput :: PsvOutputConfig -> Cluster a -> Either SeaError Doc
...
schemaOfProgram :: Cluster a -> Either SeaError [PsvColumn]
schemaOfProgram =
...
schemaOfFleet :: PsvOutputConfig -> [Cluster a] -> Either SeaError PsvSchema
